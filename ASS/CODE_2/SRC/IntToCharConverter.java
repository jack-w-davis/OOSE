...
public class IntToCharConverter extends DisplayerDecorator
{
    private Map<String,Character> map = new HashMap<>();

    public IntToCharConverter(String filePath,Displayer displayer)
    {
        setNext(displayer);
        readFile(filePath);
    }
    ...
    public Grid<String> performOperation(Maze maze)
    {
        ...
        System.out.println("---GRID CONVERTED FROM DIGIT TO STR---");
