...
//     private static final long DURATION = 1000;
    ...
    public ResponderCommImpl()
    {
        ...
        //Fire put out in 'low' 
        events.add(new REvent(6, "fire", true, "Midtown")); 
        //Fire goes from 'low' -> 'high' -> responders arrive -> 'low' -> end
        events.add(new REvent(18, "fire", true, "Hill Valley"));
        // events.add(new REvent(20, "flood", true, "Melbourne"));
        // spill -> active spill -> res arrives -> res leaves -> res returns
        //       -> end 
        events.add(new REvent(35, "chemical", true, "Perth"));
        events.add(new REvent(38, "chemical", false, "Perth"));
        events.add(new REvent(41, "chemical", true, "Perth"));
