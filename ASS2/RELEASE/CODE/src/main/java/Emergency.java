...
public class Emergency implements ContextObserver
{
    ...
    /**
     * This is used to update the boolean value 'attended'.
     * it also calls contextChange() to allow the state object to know that 
     * something has changed within it's context object (the emergency)
     */
    ...
    /**
     * changes the state of the state obj. E.G. 'fire low' -> 'fire high'
     * it then also updates the state change time, which is a variable that
     * the state obj can reference for the last time the state changed
     */
    ...
    /**
     * belwo are all one-line getters, which is why they have no comment
     *     
------------------------------------------------------------------------------*/
